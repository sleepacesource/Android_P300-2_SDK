...
//		SdkLog.log(TAG+" onCreateView-----------");
	...
	protected void initListener() {
		// TODO Auto-generated method stub
		super.initListener();
		getP300Helper().addConnectionStateCallback(stateCallback);
	...
	public void onResume() {
		// TODO Auto-generated method stub
		super.onResume();
		boolean isConnected = getP300Helper().isConnected();
	...
	private OnCheckedChangeListener checkedChangeListener = new OnCheckedChangeListener() {
		...
		public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
			...
			getP300Helper().setAlarm(AlarmSettingActivity.alarmConfig.isEnable(), AlarmSettingActivity.alarmConfig.getHour(), AlarmSettingActivity.alarmConfig.getMinute(), AlarmSettingActivity.alarmConfig.getDuration(), 3000, setAlarmCallback);
		}
	};
...
//							tvUpgrade.setText(R.string.update_completed);
	...
	public void onDestroyView() {
		// TODO Auto-generated method stub
		super.onDestroyView();
		getP300Helper().removeConnectionStateCallback(stateCallback);
	}
...
//			InputStream is = getResources().getAssets().open("Z2_V1.11.des");
			getP300Helper().upgradeDevice(bean.crcDes, bean.crcBin, bean.is, new IResultCallback<Integer>() {
				@Override
...
//					SdkLog.log(TAG+" upgradeDevice " + cd);
					mActivity.runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							if(cd.isSuccess()){
								...
								upgrading = false;
								btnUpgrade.setEnabled(getP300Helper().isConnected());
								mActivity.hideUpgradeDialog();
			...
			getP300Helper().getBattery(1000, new IResultCallback<BatteryBean>() {
				@Override
...
//			bean.crcDes = 587897703l;
			...
			InputStream is = mActivity.getResources().getAssets().open("P300-2_20181213_1.01_beta.des");
			FirmwareBean bean = new FirmwareBean();
			bean.is = is;
			bean.crcBin = 1839756958l;
			bean.crcDes = 654638642l;
